Pod::Spec.new do |s|
  ...
  s.source           = { :git => "https://github.com/techery-pods-mirror/RXPromise.git", :tag => s.version.to_s }
  ...
  s.public_header_files = "RXPromise\ Libraries/Source/RXPromise.h", "RXPromise\ Libraries/Source/RXPromise+RXExtension.h", "RXPromise\ Libraries/Source/RXSettledResult.h"
